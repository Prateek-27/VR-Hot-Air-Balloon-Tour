...
public class move_F : MonoBehaviour
{
    ...
    void Update()
    {
        if (gaze)
        {
            ...
            {
                playerCameraGameObject.transform.position += new Vector3(0, 0, 1f * Time.deltaTime);
                balloon.transform.position += new Vector3(0, 0, 1f * Time.deltaTime);
            }
